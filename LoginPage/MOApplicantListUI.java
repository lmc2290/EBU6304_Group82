...
public class MOApplicantListUI extends JPanel {
    ...
    private JPanel createTopPanel() {
        ...
        titleLabel = new JLabel("\uD83D\uDC65  MO Applicant List");
        ...
        limitProgressBar.setPreferredSize(new Dimension(200, 22));
        limitProgressBar.setMaximumSize(new Dimension(Integer.MAX_VALUE, 22));
